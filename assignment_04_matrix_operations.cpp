...
int main() {
    ...
    int p;
    cout << "Enter number of columns for Matrix C (to multiply A x C): ";
    cin >> p;

    int C[MAX_SIZE][MAX_SIZE];
    inputMatrix(C, n, p, "Matrix C");

    int product[MAX_SIZE][MAX_SIZE];
    multiplyMatrices(A, C, product, m, n, p);
